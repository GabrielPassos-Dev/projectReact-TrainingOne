    ...
    <ul className="bg-slate-300 rounded-md p-6 flex flex-col gap-4">
      ...
      {shoppingCart.map((currentItem) => (
        <li className="flex gap-2">
          ...
          <button className="px-2 py-2 bg-red-600 text-white font-semibold rounded-lg shadow-md hover:bg-red-700 hover:shadow-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2">
            <Trash2 />
          </button>
        </li>
      ))} 
